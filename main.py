...
class gain(tk.Tk):
    def __init__(self):
        ...
        self.splash_frame = tk.Frame(self, background="sky blue")
        self.splash_frame.pack(fill="both", expand=True)

        self.image_editor_window = tk.Frame(self)

        wallpaper = Image.open('c:\\Users\\adilet\\Desktop\\ABU\\12345.jpg')
        wallpaper = wallpaper.resize((window_width, window_height - 30), Image.ANTIALIAS)
        wallpaper = ImageTk.PhotoImage(wallpaper)

        self.loading = Image.open('c:\\Users\\adilet\\Desktop\\ABU\\12345.jpg')
        self.loading = self.loading.resize((70, 60), Image.ANTIALIAS)
        ...
        self.developer_label = tk.Label(self,  foreground="white",
                                        font="lucida 11 bold", background='#0088cc')
        self.developer_label.place(x=350, y=260)

        self.x = 8

        self.button_background = 'sky blue'
        ...
        flip_icon = Image.open('c:\\Users\\adilet\\Desktop\\ABU\\mirror.png')
        flip_icon = flip_icon.resize((40, 40), Image.ANTIALIAS)
        flip_icon = ImageTk.PhotoImage(flip_icon)

        rotate_icon = Image.open('c:\\Users\\adilet\\Desktop\\ABU\\rotate.png')
        rotate_icon = rotate_icon.resize((40, 40), Image.ANTIALIAS)
        rotate_icon = ImageTk.PhotoImage(rotate_icon)

        next_icon = Image.open('c:\\Users\\adilet\\Desktop\\ABU\\right.jpg')
        next_icon = next_icon.resize((40, 40), Image.ANTIALIAS)
        next_icon = ImageTk.PhotoImage(next_icon)

        previous_icon = Image.open('c:\\Users\\adilet\\Desktop\\ABU\\left.png')
        previous_icon = previous_icon.resize((40, 40), Image.ANTIALIAS)
        previous_icon = ImageTk.PhotoImage(previous_icon)

        adjust_icon = Image.open('c:\\Users\\adilet\\Desktop\\ABU\\adjust.jpg')
        adjust_icon = adjust_icon.resize((40, 40), Image.ANTIALIAS)
        adjust_icon = ImageTk.PhotoImage(adjust_icon)

        filter_icon = Image.open('c:\\Users\\adilet\\Desktop\\ABU\\filters.jpg')
        filter_icon = filter_icon.resize((40, 40), Image.ANTIALIAS)
        filter_icon = ImageTk.PhotoImage(filter_icon)

        save_icon = Image.open('c:\\Users\\adilet\\Desktop\\ABU\\save.jpg')
        save_icon = save_icon.resize((40, 40), Image.ANTIALIAS)
        save_icon = ImageTk.PhotoImage(save_icon)

        delete_icon = Image.open('c:\\Users\\adilet\\Desktop\\ABU\\del.jpg')
        delete_icon = delete_icon.resize((40, 40), Image.ANTIALIAS)
        delete_icon = ImageTk.PhotoImage(delete_icon)

        power_off_icon = Image.open('c:\\Users\\adilet\\Desktop\\ABU\\off.jpg')
        power_off_icon = power_off_icon.resize((40, 40), Image.ANTIALIAS)
        power_off_icon = ImageTk.PhotoImage(power_off_icon)

        self.error_icon = Image.open('c:\\Users\\adilet\\Desktop\\ABU\\error.jpg')
        ...
        self.open_image_small_icon = Image.open('c:\\Users\\adilet\\Desktop\\ABU\\resize.jpg')
        self.open_image_small_icon = self.open_image_small_icon.resize((40, 40), Image.ANTIALIAS)
        self.open_image_small_icon = ImageTk.PhotoImage(self.open_image_small_icon)

        self.checked_icon = Image.open('c:\\Users\\adilet\\Desktop\\ABU\\hinata.jpg')
        self.checked_icon = self.checked_icon.resize((40, 40), Image.ANTIALIAS)
        self.checked_icon = ImageTk.PhotoImage(self.checked_icon)

        self.unchecked_icon = Image.open('c:\\Users\\adilet\\Desktop\\ABU\\sakura.jpg')
        self.unchecked_icon = self.unchecked_icon.resize((40, 40), Image.ANTIALIAS)
        self.unchecked_icon = ImageTk.PhotoImage(self.unchecked_icon)

        reset_icon = Image.open('c:\\Users\\adilet\\Desktop\\ABU\\sharlot.jpg')
        reset_icon = reset_icon.resize((40, 40), Image.ANTIALIAS)
        reset_icon = ImageTk.PhotoImage(reset_icon)

        color_picker_icon = Image.open('c:\\Users\\adilet\\Desktop\\ABU\\fel.jpg')
        color_picker_icon = color_picker_icon.resize((40, 40), Image.ANTIALIAS)
        ...
        previous_b.bind("<Enter>", lambda e: mouse_hover(previous_b, color='#0088cc'))
        ...
        rotate_b.bind("<Enter>", lambda e: mouse_hover(rotate_b, color='#0088cc'))
        ...
        flip_b.bind("<Enter>", lambda e: mouse_hover(flip_b, color='#0088cc'))
        ...
        self.delete_b.bind("<Enter>", lambda e: mouse_hover(self.delete_b, color='#0088cc'))
        ...
        next_b.bind("<Enter>", lambda e: mouse_hover(next_b, color='#0088cc'))
        ...
        exit_window = tk.Button(self.image_editor_window, image=power_off_icon, compound="left",
                                text="Exit", font="lucida 11 bold", foreground='white', background="gray",
        ...
        return_window = tk.Button(self.image_editor_window, image=power_off_icon, compound="left",
                                  text="Return", font="lucida 11 bold", foreground='white', background="gray",
        ...
        self.side_frame = tk.Frame(self.image_editor_window, background="#5885AF")

        adjust_b = tk.Button(self.side_frame, text="Adjust", foreground="white", compound="left", font="lucida 11 bold",
                             image=adjust_icon, background="gray", cursor="hand2",
        ...
        filter_b = tk.Button(self.side_frame, text="Filters", foreground="white", compound="left",
                             font="lucida 9 bold", image=filter_icon, background="gray", cursor="hand2",
        ...
        self.reset_b = tk.Button(self.image_editor_window, text="Reset", foreground="WHITE", compound="left",
                                 font="lucida 11 bold", image=reset_icon, background="gray",
                                 command=self.reset, padx=15, cursor="hand2")
        ...
        self.draw_b = tk.Button(self.image_editor_window, text="Draw", image=self.unchecked_icon, foreground="white",
                                font="lucida 11 bold", compound="left", background="gray", command=self.activate_draw,
                                padx=3, cursor="hand2")
        ...
        self.crop_b = tk.Button(self.image_editor_window, text="Crop", image=self.unchecked_icon, foreground="white",
                                font="lucida 11 bold", compound="left", background="gray",
        ...
        self.crop_save = tk.Button(self.image_editor_window, image=save_icon, compound='left', text="Save",
                                   foreground="white", font="lucida 11 bold", background="gray",
        ...
        self.save_b = tk.Button(self.image_editor_window, text="Save", foreground="white", compound="left",
                                font="lucida 11 bold", state='disabled', image=save_icon, background="gray",
        ...
        self.draw_save = tk.Button(self.image_editor_window, image=save_icon, compound='left', text="Save",
                                   foreground="white", font="lucida 10 bold", background="gray",
        ...
        version_label = tk.Label(self.button_frame2,text="v 1.0", background=self.button_frame_color,
                                   foreground="white", font="lucida 11 bold")
        ...
        self.open_image_button = tk.Button(self.image_editor_window, command=self.open_image, cursor="hand2",
                                           image=self.open_image_icon, compound='top', text="SELECT A FILE",
                                           font="lucida 12 bold", foreground="white", bd=0, background="gray",)

        self.open_image_button.bind("<Enter>", lambda e: mouse_hover(self.open_image_button, color='#0088cc'))
        ...
        self.pencil_size = 2
        self.pencil_color = 'pink'

        self.pencil_size_label = tk.Label(self.image_editor_window, text="Size", font="lucida 11 bold",
        ...
        self.pencil_size_scale = tk.Scale(self.image_editor_window, from_=1, to=15, sliderrelief='flat',
                                          ...
                                          command=self.change_pencil_size, cursor="hand2", background='gray',
                                          troughcolor='#C3E0E5', activebackground='#274472')

        self.color_chooser_button = tk.Button(self.image_editor_window, image=color_picker_icon, text="Color",
                                              font="lucida 10 bold", cursor="hand2", background='#F9D030',
    ...
    def open_image(self):
        ...
        if file_object:
            ...
            self.side_frame.place(x=1500, y=200)
            self.save_b.place(x=580, y=650)
            self.draw_b.place(x=700, y=650)
            self.crop_b.place(x=800, y=650)
            self.reset_b.place(x=900, y=650)
    ...
    def show_image(self, image=None, modified=None):
        ...
        if image:
            try:
                ...
                self.error_b.place(x=900, y=900)
                self.error = True
                return
    ...
    def get_mouse_pos(self, event):
        if not self.draw_active and self.crop_active:
            ...
            self.rect = self.image_canvas.create_rectangle(0, 0, 0, 0, outline="YELLOW", width=3)
    ...
    def activate_draw(self):
        if self.original_image and not self.error:
            if not self.draw_active:
                ...
                self.pencil_size_label.place(x=1060, y=800)
                self.pencil_size_scale.place(x=1100, y=800)
                self.color_chooser_button.place(x=1200, y=800)
